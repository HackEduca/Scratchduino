...
import datetime
import ConfigParser
#import s2a_fm_windowed_oo
from Tkinter import * #import widget classes in order to be able to print on
                      #the text area of the main application window



class ScratchduinoCommandHandlers:
    """
    ...
    def __init__(self, frame, firmata, com_port, total_pins_discovered, number_of_analog_pins_discovered):
        """
