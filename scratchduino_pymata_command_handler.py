__author__ = 'Copyright (c) 2013 Alan Yorinks. (c) 2015 Computacao na Escola. All rights reserved.'

"""
Copyright
 (c) 2013-14 Alan Yorinks.
 (c) 2015 Computacao na Escola.
 All rights reserved.
...
class PyMataCommandHandler(threading.Thread):
    ...
    def __init__(self, pymata, frame):
        """
    ...
    def auto_discover_board(self):
        ...
        self.frame.show_msg_param(43, str(time.time() - start_time))
        ...
        self.frame.show_msg_param(44, str(self.total_pins_discovered))
        self.frame.show_msg_param(45, str(self.number_of_analog_pins_discovered))
